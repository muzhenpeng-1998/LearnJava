package com.example.study.IOC.day2;

import com.example.study.IOC.day2.bean.Address;
import com.example.study.IOC.day2.bean.Person;
import org.springframework.context.ApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;

public class MyTest {
    public static void main(String[] args) {
        ApplicationContext context = new ClassPathXmlApplicationContext("com.example.study.IOC.day2/ioc.xml");
        /*根据bean标签的id来获取对象*/
